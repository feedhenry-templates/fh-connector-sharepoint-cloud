...
module.exports = function() {
  ...
  listItems.get('/:guid/items/:itemId', function(req, res){
    return req.sharepoint.listItems.read(params.guid, params.itemId, handleResponse(res));
  });
  
  listItems['delete']('/:guid/items/:itemId', function(req, res){
    return req.sharepoint.listItems.del(params.guid, params.itemId, handleResponse(res));
  });
